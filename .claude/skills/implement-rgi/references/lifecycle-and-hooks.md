...
- Runs only when `verbose`. Logs the per-term energy
  `bond=.. angle=.. chiral=.. plane=.. cistrans=.. torsion=.. vdw=.. distance=.. rmsd=..
...
restraints_config:
  ...
  conformer_restraints_config:
    ...
    torsion: {weight: 0.0}                           # chi/omega/sp2; OFF by default. Set weight 1 to enable; optional slack (radians).
